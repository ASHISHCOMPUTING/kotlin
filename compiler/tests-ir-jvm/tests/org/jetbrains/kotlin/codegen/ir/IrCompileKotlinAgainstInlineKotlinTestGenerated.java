...
public class IrCompileKotlinAgainstInlineKotlinTestGenerated extends AbstractIrCompileKotlinAgainstInlineKotlinTest {
    ...
    public static class AnonymousObject extends AbstractIrCompileKotlinAgainstInlineKotlinTest {
        ...
        @TestDataPath("$PROJECT_ROOT")
        @RunWith(JUnit3RunnerWithInners.class)
        public static class Stateless extends AbstractIrCompileKotlinAgainstInlineKotlinTest {
            ...
            public void testLocalFunction3() throws Exception {
                String fileName = KotlinTestUtils.navigationMetadata("compiler/testData/codegen/boxInline/anonymousObject/stateless/localFunction3.kt");
                doTest(fileName);
            }
        }
